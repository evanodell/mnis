...
#' @export
#' @examples \dontrun{
#' x <- mnis_ElectionsContested(172)
#'
#' }

# http://data.parliament.uk/membersdataplatform/memberquery.aspx

mnis_ElectionsContested <- function(ID = NULL, mem_id = TRUE, dods_id = FALSE, pims_id = FALSE) {
    ...
    query <- paste0(baseurl, ID, "/ElectionsContested")
