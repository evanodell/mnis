#' mnis_base
#'
#' Basic function for the MNIS API lookup. The function requests data in JSON format. The type of object, and all URLs, paths and parameters are user-defined.
