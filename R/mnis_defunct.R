...
mnis_BasicDetails <- function(ID = NULL, mnis_id = TRUE, ref_dods = FALSE, tidy = TRUE) {
    ...
    mnis_basic_details(ID = ID, mnis_id = mnis_id, ref_dods = ref_dods, tidy = tidy)
}
...
#' @rdname mnis_defunct
#' @usage NULL
mnis_PreferredNames <- function(ID = NULL, mnis_id = TRUE, ref_dods = FALSE, tidy = TRUE) {
...
mnis_JoinedBetween <- function(start_date = "1900-01-01", end_date = Sys.Date(), house = "all", party = NULL, eligible = "all", tidy = TRUE) {
