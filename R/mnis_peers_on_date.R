...
#'
#' @return A tibble with information on all Peers who were members of the House of Lords on the date specified (if only date1 is included as a parameter), or on or between the two dates if both date1 and date2 are specified.
#' @export
