...
Since 0.2.3 I have added a function to remove byte order marks from the API return, switched from data frames to tibbles for the default data class, and clarified error messages on `mnis_all_members` and `mnis_additional`.

## Test environments

* Ubuntu 12.04 (on Travis-CI): R 3.3.4
* local MacOS 10.12.4 installation, R 3.3.4
